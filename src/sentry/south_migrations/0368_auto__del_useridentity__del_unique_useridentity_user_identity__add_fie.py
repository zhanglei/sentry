...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'IdentityProvider.config'
        db.add_column('sentry_identityprovider', 'config',
                      self.gf('sentry.db.models.fields.encrypted.EncryptedJsonField')(default={}),
                      keep_default=False)

        # Adding field 'Identity.user'
        db.add_column('sentry_identity', 'user',
                      self.gf('sentry.db.models.fields.foreignkey.FlexibleForeignKey')(
                          default=None, to=orm['sentry.User']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'IdentityProvider.config'
        db.delete_column('sentry_identityprovider', 'config')

        # Deleting field 'Identity.user'
        db.delete_column('sentry_identity', 'user_id')
    ...
    models = {
        ...
        'sentry.apiapplication': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "'7cf6336696514992ac96d7aad8140153981ecb8795b54b83994894f885f408d0'", 'unique': 'True', 'max_length': '64'}),
            'client_secret': ('sentry.db.models.fields.encrypted.EncryptedTextField', [], {'default': "'a9b7193b6506433db2c5903cf1b3356d151e53d372fa4c09a4bdf8da335da1c9'"}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'homepage_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'Smiling Piranha'", 'max_length': '64', 'blank': 'True'}),
        ...
        'sentry.apigrant': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'58cfec326c95434fb170895997c10f6c'", 'max_length': '64', 'db_index': 'True'}),
        ...
        'sentry.apitoken': {
            ...
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'refresh_token': ('django.db.models.fields.CharField', [], {'default': "'44820a3a12644b99a39e0b4d27fcbae58da2656f62b140939053c1c7bf349e2f'", 'max_length': '64', 'unique': 'True', 'null': 'True'}),
            'scope_list': ('sentry.db.models.fields.array.ArrayField', [], {'of': ('django.db.models.fields.TextField', [], {})}),
            'scopes': ('django.db.models.fields.BigIntegerField', [], {'default': 'None'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'5a024f71abde4ad4b921b54d05ad5f6fb7d5b05a79c0454da2c213e870f54bf4'", 'unique': 'True', 'max_length': '64'}),
            'user': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.User']"})
        },
        ...
        'sentry.groupshare': {
            ...
            'project': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.Project']"}),
            'user': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.User']", 'null': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'2065fd5c732249d88ad26ee5dea122b8'", 'unique': 'True', 'max_length': '32'})
        },
        'sentry.groupsnooze': {
        ...
        'sentry.scheduleddeletion': {
            ...
            'guid': ('django.db.models.fields.CharField', [], {'default': "'98ab6c9a6cf24ac7955b73b6f49d274c'", 'unique': 'True', 'max_length': '32'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
        ...
        'sentry.useremail': {
            ...
            'validation_hash': ('django.db.models.fields.CharField', [], {'default': "u'jwoEHAvMhYaZ1ErD9scYQwuoVBlSbWuB'", 'max_length': '32'})
        },
        'sentry.userip': {
