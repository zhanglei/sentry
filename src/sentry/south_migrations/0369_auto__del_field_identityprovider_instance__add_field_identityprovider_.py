...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'IdentityProvider.instance'
        db.delete_column(u'sentry_identityprovider', 'instance')

        # Adding field 'IdentityProvider.organization'
        db.add_column('sentry_identityprovider', 'organization',
                      self.gf('sentry.db.models.fields.foreignkey.FlexibleForeignKey')(default=None, to=orm['sentry.Organization']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'IdentityProvider.instance'
        raise RuntimeError("Cannot reverse this migration. 'IdentityProvider.instance' and its values cannot be restored.")

        # The following code is provided here to aid in writing a correct migration        # Adding field 'IdentityProvider.instance'
        db.add_column(u'sentry_identityprovider', 'instance',
                      self.gf('django.db.models.fields.CharField')(max_length=64),
                      keep_default=False)

        # Deleting field 'IdentityProvider.organization'
        db.delete_column('sentry_identityprovider', 'organization_id')
    ...
    models = {
        ...
        'sentry.apiapplication': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "'7e74d9a2b60d4934a7fe1b8798d87211ef1f0a80320d4a2f9da2e556f30b806f'", 'unique': 'True', 'max_length': '64'}),
            'client_secret': ('sentry.db.models.fields.encrypted.EncryptedTextField', [], {'default': "'d7d0dfd77baf4a35b60dca54021dafb5dc6140d73f8945059df8896b7bb49fe1'"}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'homepage_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'Dynamic Pheasant'", 'max_length': '64', 'blank': 'True'}),
        ...
        'sentry.apigrant': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'64032bc4b6c944889b93a97cd25e370e'", 'max_length': '64', 'db_index': 'True'}),
        ...
        'sentry.apitoken': {
            ...
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'refresh_token': ('django.db.models.fields.CharField', [], {'default': "'2847c01fd98347eebd6d48dad1fec0631b351da1429e4ddb8054e24304f71548'", 'max_length': '64', 'unique': 'True', 'null': 'True'}),
            'scope_list': ('sentry.db.models.fields.array.ArrayField', [], {'of': ('django.db.models.fields.TextField', [], {})}),
            'scopes': ('django.db.models.fields.BigIntegerField', [], {'default': 'None'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'c75b14721b2541ad90116e1fd8265ad4a589fd6a5ebf4cf9855d48cdf6977dd3'", 'unique': 'True', 'max_length': '64'}),
            'user': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.User']"})
        },
        ...
        'sentry.groupshare': {
            ...
            'project': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.Project']"}),
            'user': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.User']", 'null': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'8838fe2b8a2943fd874d9befea90192f'", 'unique': 'True', 'max_length': '32'})
        },
        'sentry.groupsnooze': {
        ...
        'sentry.scheduleddeletion': {
            ...
            'guid': ('django.db.models.fields.CharField', [], {'default': "'97121d29393547e0aeb985c6ddeca3c8'", 'unique': 'True', 'max_length': '32'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
        ...
        'sentry.useremail': {
            ...
            'validation_hash': ('django.db.models.fields.CharField', [], {'default': "u'wOxURR1VYuP3YHzRednn0QK5J2zAKnNS'", 'max_length': '32'})
        },
        'sentry.userip': {
